...
import io.annchain.og.sdk.server.OGServer;
import io.annchain.og.sdk.types.*;
import org.web3j.abi.FunctionEncoder;
import org.web3j.abi.FunctionReturnDecoder;
import org.web3j.abi.TypeReference;
import org.web3j.abi.datatypes.*;
import io.annchain.og.sdk.server.OGRequestGET;
import io.annchain.og.sdk.server.OGRequestPOST;
...
public class OG {
     ...
     */
    public SendTransactionResp SendTransactionAndJoin(Account account, String to, BigInteger value, IConfirmCallback callback) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public SendTransactionResp TransferTokenAndJoin(Account account, String to, Integer tokenID, BigInteger value, IConfirmCallback callback) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public SendTransactionResp InitialTokenOfferingAndJoin(Account account, BigInteger value, Boolean additionalIssue, String tokenName, IConfirmCallback callback) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public SendTransactionResp OfferMoreTokenAndJoin(Account account, BigInteger value, Integer tokenID, IConfirmCallback callback) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public SendTransactionResp DestroyTokenAndJoin(Account account, Integer tokenID, IConfirmCallback callback) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public SendTransactionResp DeployContractAndJoin(Account account, BigInteger value, String bytecode, List<Type> constructorParameters, IConfirmCallback callback) throws IOException, InterruptedException {
...
//        System.out.println("callContract data: " + data);
     ...
     * @throws InterruptedException
     */
    public SendTransactionResp CallContractAndJoin(Account account, String contractAddress, BigInteger value, String funcName, List<Type> inputs, List<TypeReference<?>> outputParams, IContractCallback callback) throws IOException, InterruptedException {
        Function func = new Function(funcName, inputs, outputParams);
...
//            System.out.println("data: " + contractResp.getData());
    ...
    private void checkContractCall(SendTransactionResp txResp, List<TypeReference<Type>> outputParams, IContractCallback callback) throws IOException, InterruptedException  {
        ...
        QueryReceiptResp receipt = checkHelper(txResp, callback.IntervalTimeMillis(), callback.TimeoutMillis());
        if (receipt == null) {
            resp.setErr("confirm timeout");
            callback.ContractEvent(resp);
            return;
    ...
    private QueryReceiptResp checkHelper(SendTransactionResp txResp, Integer callbackIntervalMillis, Integer callbackTimeoutMillis) throws IOException, InterruptedException {
        String hash = txResp.getHash();
        Long timeout = System.currentTimeMillis() + callbackTimeoutMillis;
        while (System.currentTimeMillis() < timeout) {
            QueryReceiptResp resp = this.QueryReceipt(hash);
            if (resp.getData() == null) {
                Thread.sleep(callbackIntervalMillis);
                continue;
            }
            return resp;
        }
